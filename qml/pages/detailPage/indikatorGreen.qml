    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Image {
                ...
                source: "../../../images/modul_images/indikator green.png"
...
Indikator lampu berwarna hijau berfungsi untuk tanda Run/jalan.")
                anchors.left: parent.left
            ...
            Label {
                id: label
                color: "#ffffff"
                text: qsTr("Layout Indikator Green")
                anchors.left: parent.left
                anchors.right: parent.right
                anchors.top: parent.top
