    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Image {
                ...
                source: "../../../images/modul_images/HK1-20.png"
            ...
            Text {
                id: text1
                color: "#ffffff"
                text: qsTr("Kontak Auxillary HK1-20 memiliki arus operasional terukur 24V=6A, 240V=4A, 380/400V=3A, 690=1A. Serta memiliki tegangan pengenal impuls menahan rangkaian bantu 6kV, dan tegangan isolasi pengenal 690V")
                anchors.left: parent.left
