    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Image {
                ...
                source: "../../../images/modul_images/selector switch.png"
            ...
            Text {
                id: text1
                color: "#ffffff"
                text: qsTr("C2SS1-10B-10 Selector Switch memiliki rated frequency supply circuit 50-60 hz, serta memiliki rated operational current AC (24/127V=1.5A,220/240V=1A), serta rated operational current DC (24V=0.3A, 125V=0.2A)")
                anchors.left: parent.left
            ...
            Label {
                id: label
                color: "#ffffff"
                text: qsTr("Layout Selector Switch")
                anchors.left: parent.left
                anchors.right: parent.right
                anchors.top: parent.top
