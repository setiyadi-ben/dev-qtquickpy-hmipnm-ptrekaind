    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Image {
                ...
                source: "../../../images/modul_images/kondensor.png"
            ...
            Text {
                id: text1
                color: "#ffffff"
                text: qsTr("Kondensor adalah salah satu komponen pada sistem pengapian konvensional motor yang menggunakan platina. Kondensor motor berfungsi untuk menyimpan arus listrik sementara yang dihasilkan oleh induksi diri pada koil.")
                anchors.left: parent.left
