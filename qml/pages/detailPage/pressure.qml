    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Image {
                ...
                source: "../../../images/modul_images/press.png"
            ...
            Text {
                id: text1
                color: "#ffffff"
                text: qsTr("Sensor tekanan mengukur tekanan, biasanya gas atau cairan. Tekanan adalah ekspresi dari gaya yang dibutuhkan untuk menghentikan cairan dari perluasan, dan biasanya dinyatakan dalam hal gaya per satuan luas.")
                anchors.left: parent.left
