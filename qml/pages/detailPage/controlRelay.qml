    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Image {
                ...
                source: "../../../images/modul_images/control relay.png"
            ...
            Text {
                id: text1
                color: "#ffffff"
                text: qsTr("RM35HZ21FM Relai kendali frekuensi memiliki parameter pemantauan relai yaitu Overfrequency dan Underfrequency 50 atau 60 hz dan memiliki tipe time delay adjustable 0.1...10s, +/- 10% pada crossing the treshold serta memiliki kapasitas switching 1250 VA, arus switching minimum 10 mA pada 5 VDC, konsumsi daya maksimum 6 VA AC, rentang pengukuran 40...70 Hz frekuensi")
                anchors.left: parent.left
            ...
            Label {
                id: label
                color: "#ffffff"
                text: qsTr("Layout Control Relay")
                anchors.left: parent.left
                anchors.right: parent.right
                anchors.top: parent.top
